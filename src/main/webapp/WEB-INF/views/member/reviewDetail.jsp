    ...
    <div class="row block-9">
      <div class="login-form col-md-8 d-flex">
        <form action="doLogin" name="loginForm" id="loginForm" method="post" class="bg-white p-5 contact-form">
			  ...
			  <br><br>
			  <c:if test="${aDto eq null }">
			  <div class="ftco-animate text-center">
			  	<h5 >답변이 존재하지 않습니다.</h5>
			  </div>
			  <br><br>
	          <div class="form-group text-center">
	            <input type="button" value="뒤로가기" class="btn btn-primary py-3 px-5" onclick="location.href='myPage?userId=${sessionScope.userId}&orderNum=1&reviewNum=1#reviewList'">
	          </div>
			  </c:if>
			  ...
			  <div class="col-lg-12 bg-light">					 		
				 <h5>ㄴ관리자</h5>	<br>
				 <p>${aDto.content }</p>
				 <p style="float:right;">${aDto.regdate }</p>				
			  </div>
	          <br><br><br>
	          <div class="form-group text-center">
	            <input type="button" value="뒤로가기" class="btn btn-primary py-3 px-5" onclick="location.href='myPage?userId=${sessionScope.userId}&orderNum=1&reviewNum=1#reviewList'">
